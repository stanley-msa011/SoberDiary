...
public class PageAnimationTaskVertical extends AsyncTask<Void, Void, Void> {
	...
	public static final int gaps = 40;
	...
	public PageAnimationTaskVertical(PageWidgetVertical pageWidget, PointF from, PointF to,int[] bgs,PageAnimationCaller caller,int startImageIdx){
